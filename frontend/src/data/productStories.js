...
export const PRODUCT_STORIES = {
  guidebot: {
    ...
    stats: [
      { value: 9, suffix: "h", label: "Continuous runtime", icon: "IconRuntime", iconSize: 46 },
      ...
      items: [
        {
          icon: "FaStore",
          title: "Retail & Malls",
          text: "Wayfinding to shops, mobile advertising, and \"Spin & Win\" promotions.",
          placeholder: { image: "/GuideBot-Retail-Mall.webp", ratio: "16 / 9" },
        },
        {
          icon: "FaHotel",
          title: "Hospitality & Hotels",
          text: "Receptionist duties and tourist info.",
          placeholder: { image: "/GuideBot-Hospitality-Hotels.webp", ratio: "16 / 9" },
        },
        {
          icon: "FaBuilding",
          title: "Corporate Offices",
          text: "Visitor registration and employee engagement.",
          placeholder: { image: "/GuideBot-Corporate-Offices.webp", ratio: "16 / 9" },
        },
        {
          icon: "FaHospital",
          title: "Healthcare",
          text: "Directing patients to clinics and reducing administrative staff workload.",
          placeholder: { image: "/GuideBot-Healthcare.webp", ratio: "16 / 9" },
        },
        {
          icon: "FaLandmark",
          title: "Museums & Galleries",
          text: "\"Docent Mode\" providing audio-visual tours of specific exhibits.",
          placeholder: { image: "/GuideBot-Museums-Galleries.webp", ratio: "16 / 9" },
        },
        {
          icon: "FaUsers",
          title: "Events & Expos",
          text: "High-tech attraction for lead generation and brand awareness.",
          placeholder: { image: "/GuideBot-Events-Expos.webp", ratio: "16 / 9" },
        },
      ],
    },
  },
